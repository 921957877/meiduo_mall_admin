"""
Django settings for meiduo_mall_admin project.
...
os.path.abspath()===>/home/python/Desktop/meiduo_tbd39/meiduo_mall_admin/meiduo_mall_admin/settings/dev.py
os.path.dirname()===>/home/python/Desktop/meiduo_tbd39/meiduo_mall_admin/meiduo_mall_admin/settings
os.path.dirname()===>/home/python/Desktop/meiduo_tbd39/meiduo_mall_admin/meiduo_mall_admin
'''
...
INSTALLED_APPS = [
    ...
    # 完整导包路径
    # 'meiduo_mall_admin.apps.users.apps.UsersConfig',
...
ROOT_URLCONF = 'meiduo_mall_admin.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            # 补充Jinja2模板引擎环境
            'environment': 'meiduo_mall_admin.utils.jinja2_env.jinja2_environment',
        },
    },
]

WSGI_APPLICATION = 'meiduo_mall_admin.wsgi.application'
...
# 数据库路由规则
DATABASE_ROUTERS = ['meiduo_mall_admin.utils.db_router.MasterSlaveDBRouter']
...
# 指定认证后端
AUTHENTICATION_BACKENDS = ['meiduo_mall_admin.utils.authenticate.MeiduoModelBackend']
